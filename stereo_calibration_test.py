...
chessboard_path = "images/ps5_calib_0"
photos_path = "images/ps5_photos_0"
...
def main():
    ...
    e_l, calib_left = f_cam.calibrateSingle("left", chess_pattern, dir_name="ps5_1_left", show_results=False)
